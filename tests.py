...
from main import number_of_columns_is, is_able_to_parse


class FileTests(unittest.TestCase):

    def test_variables_integrity(self):
        entry_value = ["data_file_path", "test_file_path", "data_file_skip_row",
                       "test_file_skip_row", "number_of_columns", "expected_header",
    ...
    def test_number_of_columns(self):
        ...
        self.assertEqual(is_able_to_parse(), expected_value)
